...
import { Input, Select, Schedule } from '@components';
							...
							<div className="d-flex align-items-center">
								<label className="avatar avatar-xl avatar-circle avatar-uploader me-5">
									<img
										...
										id="avatarNewOrganizationImg"
										src="/assets/img/160x160/img2.jpg"
									/>
									<input
										type="file"
										id="avatarNewOrganizationUploader"
								...
								<button
									type="button"
									className="js-file-attach-reset-img btn btn-white"
								>
									Delete
								</button>
							</div>
