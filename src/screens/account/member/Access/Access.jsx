...
// import ViewPermissionList from '@views/ViewPermissionList';

const Access = ({ userId = '' }) => {
	const [ options, setOptions ] = React.useState([]);
	const [ loading, setLoading ] = React.useState(false);

	const fetchPermissionByUserId = (userId) => {
		setLoading(true);
	...
	React.useEffect(() => {
		fetchPermissionByUserId(userId);
	}, []);
												...
												<div className="col-12 mb-4">
													...
													<div className="tom-select-custom">
														...
														>
															<option
																value="AF"
																data-option-template='<span className="d-flex align-items-center"><img class="avatar avatar-xss avatar-circle me-2" src="./assets/vendor/flag-icon-css/flags/1x1/af.svg" alt="Afghanistan Flag" /><span class="text-truncate">Afghanistan</span></span>'
															>
																Afghanistan
															</option>
															<option
																value="AX"
																data-option-template='<span className="d-flex align-items-center"><img class="avatar avatar-xss avatar-circle me-2" src="./assets/vendor/flag-icon-css/flags/1x1/ax.svg" alt="Aland Islands Flag" /><span class="text-truncate">Aland Islands</span></span>'
															>
																Aland Islands
															</option>
															<option
																value="AL"
																data-option-template='<span className="d-flex align-items-center"><img class="avatar avatar-xss avatar-circle me-2" src="./assets/vendor/flag-icon-css/flags/1x1/al.svg" alt="Albania Flag" /><span class="text-truncate">Albania</span></span>'
															>
																Albania
															</option>
															<option
	...
	// 			<ViewPermissionList options={options} wrapperClassName="card card-centered mb-3 mb-lg-5" />
	// 		) : (
	// 			<div className="card card-centered mb-3 mb-lg-5">
