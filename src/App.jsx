...
const App = () => {
	return (
		...
		<button className="menu" data-tooltip="Main menu" aria-label="button" role="button">
		<svg focusable="false" style={{pointerEvents: 'none'}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px" fill="var(--white2)">
		...
		<button className="btn-root btn-today" style={{cursor: 'pointer'}} aria-label="button" role="button">Today</button>
		</div>
		<div className="group-right">
		<div className="h-col-2">
		<div className="prev-next">
		<button className="prev" aria-label="button" role="button">
		<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="var(--white2)">
		<path d="M0 0h24v24H0z" fill="none" />
		...
		<button className="datetime-content" aria-label="button" role="button">
		...
		<button className="h-search" data-tooltip="search" aria-label="button" role="button">
		...
		<button className="settings" data-tooltip="settings" aria-label="button" role="button">
		...
		<button name="select__modal" id="s-modals" className="select__modal" aria-label="button" role="button">
		Month
		</button>
		</div>
		</div>
		...
		<button className="sb-toggle-form-btn" aria-label="button" role="button">
		<span className="stfb">
		...
		<button className="sbdatepicker-title" aria-label="button" role="button">October 2022</button>
		<div className="sbdatepicker-nav">
		<button className="sbdatepicker-nav--prev" aria-label="button" role="button">
		<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="var(--white3)" style={{userSelect: 'none', pointerEvents: 'none'}}>
		<path d="M0 0h24v24H0z" fill="none" />
		<path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z" />
		</svg>
		</button>
		<button className="sbdatepicker-nav--next" aria-label="button" role="button">
		<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="var(--white3)" style={{userSelect: 'none', pointerEvents: 'none'}}>
		<path d="M0 0h24v24H0z" fill="none" />
		<path d="M8.59 16.59L10 18l6-6-6-6L8.59 7.41 13.17 12z" />
		</svg>
		...
		<div className="sb-monthpicker__month" data-sbdp-month={0}>January</div>
		<div className="sb-monthpicker__month" data-sbdp-month={1}>February</div>
		<div className="sb-monthpicker__month" data-sbdp-month={2}>March</div>
		<div className="sb-monthpicker__month" data-sbdp-month={3}>April</div>
		<div className="sb-monthpicker__month" data-sbdp-month={4}>May</div>
		<div className="sb-monthpicker__month" data-sbdp-month={5}>June</div>
		<div className="sb-monthpicker__month" data-sbdp-month={6}>July</div>
		<div className="sb-monthpicker__month" data-sbdp-month={7}>August</div>
		<div className="sb-monthpicker__month" data-sbdp-month={8}>September</div>
		<div className="sb-monthpicker__month" data-sbdp-month={9}>October</div>
		<div className="sb-monthpicker__month" data-sbdp-month={10}>November</div>
		<div className="sb-monthpicker__month" data-sbdp-month={11}>December</div>
		</div>
		</aside>
		</div>
		</div>
		...
		<div className="sb__categories--header" style={{backgroundColor: 'var(--black1)'}}>
		...
		<svg xmlns="http://www.w3.sorg/2000/svg" height={24} width={24} fill="var(--white2)" style={{pointerEvents: 'none'}}>
		...
		<a href="https://github.com/chaseottofy" rel="noreferrer" target="_blank" title="github.com/chaseottofy" name="github.com/chaseottofy" className="sb-link sbl-github" role="link" aria-label="vist github.com/chaseottofy">
		...
		<button className="sb-link sbl-email" data-tooltip="ottofy@zohomail.com" role="button" aria-label="email me at ottofy@zohomail.com">
		<svg xmlns="http://www.w3.org/2000/svg" height={24} width={24} fill="var(--white2)">
		...
		<button className="sb-link sbl-portfolio" data-tooltip="portfolio in progress" role="button" aria-label="portfolio in progress">
		<svg xmlns="http://www.w3.org/2000/svg" height={24} width={24} fill="var(--white2)">
		...
		<div className="allday--col" data-allday-column={0} data-wv-top="true" />
		<div className="allday--col" data-allday-column={1} data-wv-top="true" />
		<div className="allday--col" data-allday-column={2} data-wv-top="true" />
		<div className="allday--col" data-allday-column={3} data-wv-top="true" />
		<div className="allday--col" data-allday-column={4} data-wv-top="true" />
		<div className="allday--col" data-allday-column={5} data-wv-top="true" />
		<div className="allday--col" data-allday-column={6} data-wv-top="true" />
		</div>
		</div>
		<div className="weekview__grid">
		<div className="weekview--sidebar" />
		<div className="weekview--calendar">
		<div className="week--col" data-column-index={0} data-wv-top="false" />
		<div className="week--col" data-column-index={1} data-wv-top="false" />
		<div className="week--col" data-column-index={2} data-wv-top="false" />
		<div className="week--col" data-column-index={3} data-wv-top="false" />
		<div className="week--col" data-column-index={4} data-wv-top="false" />
		<div className="week--col" data-column-index={5} data-wv-top="false" />
		<div className="week--col" data-column-index={6} data-wv-top="false" />
		</div>
		<div />
		...
		<button className="datepicker-title" role="button" aria-label="button">October 2022</button>
		<div className="datepicker-nav">
		<button className="datepicker-nav--prev" role="button" aria-label="button">
		<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="var(--white3)" style={{userSelect: 'none', pointerEvents: 'none'}}>
		<path d="M0 0h24v24H0z" fill="none" />
		<path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z" />
		</svg>
		</button>
		<button className="datepicker-nav--next" role="button" aria-label="button">
		<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="var(--white3)" style={{userSelect: 'none', pointerEvents: 'none'}}>
		<path d="M0 0h24v24H0z" fill="none" />
		<path d="M8.59 16.59L10 18l6-6-6-6L8.59 7.41 13.17 12z" />
		</svg>
		...
		<div className="monthpicker__month" data-dp-month={0}>January</div>
		<div className="monthpicker__month" data-dp-month={1}>February</div>
		<div className="monthpicker__month" data-dp-month={2}>March</div>
		<div className="monthpicker__month" data-dp-month={3}>April</div>
		<div className="monthpicker__month" data-dp-month={4}>May</div>
		<div className="monthpicker__month" data-dp-month={5}>June</div>
		<div className="monthpicker__month" data-dp-month={6}>July</div>
		<div className="monthpicker__month" data-dp-month={7}>August</div>
		<div className="monthpicker__month" data-dp-month={8}>September</div>
		<div className="monthpicker__month" data-dp-month={9}>October</div>
		<div className="monthpicker__month" data-dp-month={10}>November</div>
		<div className="monthpicker__month" data-dp-month={11}>December</div>
		</div>
		</aside>
		</aside>
		{/* MAIN APP FORM */}
		<aside className="entries__form hide-form" style={{top: 0, left: 0, bottom: 0, right: 0, margin: 'auto', maxWidth: '450px'}}>
		...
		<input type="text" placeholder="Add title" className="form--body__title-input" maxLength={50} spellCheck="false" required />
		</div>
		<div className="form--body__description form-body-single">
		<textarea placeholder="Add description" className="form--body__description-input" maxLength={200} spellCheck="false" defaultValue={""} />
		</div>
		{/* row 2: start date & time */}
		<div className="form--body__start form-body-double">
		<div className="form--body__start-icon">
		<svg xmlns="http://www.w3.org/2000/svg" height={24} width={24} fill="var(--white3)" className="form--body-svg__start">
		...
		<span className="form--body-start__date" data-form-date-type="start">
		</span>
		<div className="form-br" />
		<span className="form--body-start__time" data-form-time-type="start">
		1:30am
		</span>
		</div>
		</div>
		...
		<svg xmlns="http://www.w3.org/2000/svg" height={24} width={24} fill="var(--white3)" className="form--body-svg__end">
		<path d="m15.3 16.7 1.4-1.4-3.7-3.7V7h-2v5.4ZM12 22q-2.075 0-3.9-.788-1.825-.787-3.175-2.137-1.35-1.35-2.137-3.175Q2 14.075 2 12t.788-3.9q.787-1.825 2.137-3.175 1.35-1.35 3.175-2.138Q9.925 2 12 2t3.9.787q1.825.788 3.175 2.138 1.35 1.35 2.137 3.175Q22 9.925 22 12t-.788 3.9q-.787 1.825-2.137 3.175-1.35 1.35-3.175 2.137Q14.075 22 12 22Zm0-10Zm0 8q3.325 0 5.663-2.337Q20 15.325 20 12t-2.337-5.663Q15.325 4 12 4T6.338 6.337Q4 8.675 4 12t2.338 5.663Q8.675 20 12 20Z" />
		</svg>
		</div>
		<div className="form--body__end-inputs">
		<span className="form--body-end__date" data-form-date-type="end">
		</span>
		<div className="form-br" />
		<span className="form--body-end__time" data-form-time-type="end">
		3:30am
		</span>
		</div>
		</div>
		...
		<aside className="close-options-floating__btn" style={{zIndex: -1, userSelect: 'none', pointerEvents: 'none', opacity: 0, boxShadow: 'none'}}>
		...
		<button className="form--footer__button-cancel" type="reset" role="button" aria-label="button">reset</button>
		<button className="form--footer__button-save" type="submit" role="button" aria-label="button">save</button>
		</div>
		{/* footer */}
		</form>
		</aside>
		...
		<div className="view-option" data-view-option="day" data-view-key="D">Day</div>
		<div className="view-option" data-view-option="week" data-view-key="W">Week</div>
		<div className="view-option" data-view-option="month" data-view-key="M">Month</div>
		<div className="view-option" data-view-option="year" data-view-key="Y">Year</div>
		<div className="view-option" data-view-option="list" data-view-key="L">List</div>
		</div>
		</div>
		</aside>
		...
		<input type="text" className="category__form-input" placeholder="Category Name" maxLength={20} minLength={1} required />
		...
		<button className="btn-root category__form--cancel" role="button" aria-label="button">Cancel</button>
		<button className="btn-root category__form--submit" role="button" aria-label="button">Save</button>
		</div>
		</aside>
		{/* "eye" icon that appears in day/week view */}
		<aside className="collapse-view hide-cbt">
		<svg xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px" fill="var(--white3)" className="cv-svg-off">
		<path d="M0 0h24v24H0zm0 0h24v24H0zm0 0h24v24H0zm0 0h24v24H0z" fill="none" />
		<path d="M12 7c2.76 0 5 2.24 5 5 0 .65-.13 1.26-.36 1.83l2.92 2.92c1.51-1.26 2.7-2.89 3.43-4.75-1.73-4.39-6-7.5-11-7.5-1.4 0-2.74.25-3.98.7l2.16 2.16C10.74 7.13 11.35 7 12 7zM2 4.27l2.28 2.28.46.46C3.08 8.3 1.78 10.02 1 12c1.73 4.39 6 7.5 11 7.5 1.55 0 3.03-.3 4.38-.84l.42.42L19.73 22 21 20.73 3.27 3 2 4.27zM7.53 9.8l1.55 1.55c-.05.21-.08.43-.08.65 0 1.66 1.34 3 3 3 .22 0 .44-.03.65-.08l1.55 1.55c-.67.33-1.41.53-2.2.53-2.76 0-5-2.24-5-5 0-.79.2-1.53.53-2.2zm4.31-.78l3.15 3.15.02-.16c0-1.66-1.34-3-3-3l-.17.01z" />
		</svg>
		<svg xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px" fill="var(--white3)" className="cv-svg-on hide-cbt">
		<path d="M0 0h24v24H0z" fill="none" />
		...
		<div className="go-to-err" style={{display: 'none'}}>Invalid Date</div>
		</div>
		...
		<div className="toggle-animations-icon__sm" data-tooltip="Animations Enabled">
		<svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="var(--primary2)" className="tai-on">
		...
		<svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="var(--red1)" className="tai-off hide-tai">
		<g>
		<rect fill="none" height={24} width={24} />
		...
		<div className="keyboard-disabled-sm" data-tooltip="Keyboard Shortcuts Disabled">
		...
		<div className="sm-download-json-title">
		download.json
		</div>
		</div>
		...
		<div className="sm-upload-json-title">
		upload.json
		</div>
		</div>
		</div>
		...
		<input className="theme-radio__input" name="themeoption" type="radio" defaultValue="dark" defaultChecked />
		<span>Dark</span>
		</div>
		<div className="theme-option theme-option-light">
		<input className="theme-radio__input" name="themeoption" type="radio" defaultValue="light" />
		<span>Light</span>
		</div>
		<div className="theme-option theme-option-contrast">
		<input className="theme-radio__input" name="themeoption" type="radio" defaultValue="contrast" />
		...
		<label>
		<input type="checkbox" className="smia-toggle-shortcuts-checkbox" defaultChecked />
		...
		<span className="smdt-title">
		toggle on/off
		</span>
		<div className="smdt-toggle">
		<label>
		<input type="checkbox" className="smdt-toggle-checkbox" defaultChecked />
		...
		<button className="entry__options-icon eoi__edit" data-tooltip="edit event (e)" role="button" aria-label="button">
		...
		<button className="entry__options-icon eoi__delete" data-tooltip="delete event" role="button" aria-label="button">
		<svg focusable="false" width={20} height={20} viewBox="0 0 24 24" fill="var(--white2)">
		<path d="M15 4V3H9v1H4v2h1v13c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V6h1V4h-5zm2 15H7V6h10v13z" />
		<path d="M9 8h2v9H9zm4 0h2v9h-2z" />
		</svg>
		</button>
		<button className="entry__options-icon eoi__close" data-tooltip="close (esc)" role="button" aria-label="button">
		<svg focusable="false" width={20} height={20} viewBox="0 0 24 24" fill="var(--white2)">
		...
		<div className="entry-option-desc">
		<div className="eob-icon">
		<svg xmlns="http://www.w3.org/2000/svg" height={20} width={20} className="eob-category--icon" fill="var(--primarylight1)">
		...
		<div className="keyboard-disabled-sm-two" data-tooltip="Keyboard Shortcuts Disabled">
		<svg xmlns="http://www.w3.org/2000/svg" height={24} width={24} fill="var(--red1)">
		<path d="M4 19q-.825 0-1.412-.587Q2 17.825 2 17V7q0-.825.588-1.412Q3.175 5 4 5h16q.825 0 1.413.588Q22 6.175 22 7v10q0 .825-.587 1.413Q20.825 19 20 19Zm0-2h16V7H4v10Zm4-1h8v-2H8Zm-3-3h2v-2H5Zm3 0h2v-2H8Zm3 0h2v-2h-2Zm3 0h2v-2h-2Zm3 0h2v-2h-2ZM5 10h2V8H5Zm3 0h2V8H8Zm3 0h2V8h-2Zm3 0h2V8h-2Zm3 0h2V8h-2ZM4 17V7v10Z" />
		</svg>
		</div>
