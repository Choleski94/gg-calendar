...
import { CrudLayout } from '@components/layout';
import { useCrudContext } from '@store/context/crud';
import { selectCurrentItem } from '@store/crud/selectors';

import AdminDataTable from './AdminDataTable';
import UpdatePassword from './UpdatePassword';

const SidePanelTopContent = ({ config, formElements }) => {
...
const AdminCrudModule = ({ config, createForm, updateForm }) => {
	const dispatch = useDispatch();
