																...
																<tbody>
																	<tr>
																		<td align="center" style="font-size:0px;padding:0;word-break:break-word;">
																			<div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:12px;font-weight:300;line-height:1;text-align:center;color:#575757;"> Copyright &copy; {{year}} {{comapny}}</div>
																		</td>
																	</tr>
																	<tr>
...
const EditorWithPreview = ({ setTemplateId }) => {
	...
	const previewHTML = compiledTemplate(variables);
