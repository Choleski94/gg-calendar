...
import { Divider, Button, PageHeader, Row, Col, Descriptions, Statistic, Tag } from 'antd';
...
const ReadOfferItem = ({ config, selectedItem }) => {
	...
	const [currentErp, setCurrentErp] = React.useState(selectedItem ?? resetErp);
